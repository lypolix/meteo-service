...
Современный погодный веб-сервис на Go с использованием PostgreSQL и системой cron-задач для автоматического обновления данных, интеграцией со сторонними API, и фронтендом на React для удобного и интерактивного отображения прогноза погоды по всему миру. Позволяет быстро узнать прогноз погоды для любого города мира, воспользоваться поиском с подсказками, выбрать город на карте. Система автоматически обновляет данные через cron.
